#!/usr/bin/env bash
# N-083: VTI demo-seed variance for VILA-U (N-083, sub-task 4B).
#
...
#   source activate sae
#   bash scripts/run_n083_vti_seeds.sh
#
...
#   results/vti_seed_summary.tsv   (written by run_n083_vti_summary.py)
