"""projector-norm scaling ablation on VILA-U.
...
Usage:
    python scripts/projector_norm_scaling.py
"""
...
def main() -> None:
    ...
    ax1.axhline(17.50, color="gray", linestyle="--", linewidth=0.8, label="baseline (17.50)")
    ...
    fig.suptitle(
        "VILA-U projector-norm scaling ablation\n"
